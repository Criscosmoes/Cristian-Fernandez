        ...
        <div className="skills-container">
          <div className="about-me">
            ...
            <p>
              ...
              Developer. I love to build efficient and scalable products using
          ...
          <div className="languages">
            ...
            <div className="all-languages">{allLanguages}</div>
          </div>
          <div className="languages">
            <h2 className="titles">Technologies</h2>
            <div className="all-languages">{allTechnologies}</div>
          </div>
        </div>
      </StyledAboutMe>
    </motion.div>
